proc report_metrics { when {include_erc true} {include_clock_skew true} } {
  ...
  puts "--------------------------------------------------------------------------"
  if {[info exists ::env(USE_GROUP_PATH)] && $::env(USE_GROUP_PATH)} {
  	report_checks -path_group reg2reg -path_delay min -fields {slew cap input nets fanout} -format full_clock_expanded
        report_checks -path_group in2reg -path_delay min -fields {slew cap input nets fanout} -format full_clock_expanded
        report_checks -path_group reg2out -path_delay min -fields {slew cap input nets fanout} -format full_clock_expanded
        report_checks -path_group in2out -path_delay min -fields {slew cap input nets fanout} -format full_clock_expanded
  ...
  puts "--------------------------------------------------------------------------"
  if {[info exists ::env(USE_GROUP_PATH)] && $::env(USE_GROUP_PATH)} {
        report_checks -path_group reg2reg -path_delay max -fields {slew cap input nets fanout} -format full_clock_expanded
        report_checks -path_group in2reg -path_delay max -fields {slew cap input nets fanout} -format full_clock_expanded
        report_checks -path_group reg2out -path_delay max -fields {slew cap input nets fanout} -format full_clock_expanded
        report_checks -path_group in2out -path_delay max -fields {slew cap input nets fanout} -format full_clock_expanded
