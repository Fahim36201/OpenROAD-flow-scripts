...
* First, ensure that a KLayout tech file (`.lydrc` ) exists for the platform. If not, you can download it form: https://github.com/laurentc2/ASAP7_for_KLayout/tree/main/drc
